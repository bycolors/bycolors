...
class ofApp : public ofBaseApp{
	...
	public:
        ...
        ofxAnimatableFloat tPhotoGridX;
        ofxAnimatableFloat tPhotoGridY;
        ofxAnimatableFloat tPhotoGridSize;
        ofxAnimatableOfPoint tPhotoGridPos;
